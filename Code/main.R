...
#apply cSPADE algorithm to trail with support = 0.04
itset_seq_trail <- cspade(seq_matrix_trail, 
                       parameter = list(support = 0.04), #freq sequs that occurs in at least 4% of all sequs
                       control = list(verbose = TRUE))
summary(itset_seq_trail)

#apply cSPADE algorithm to tied with support = 0.04
itset_seq_tied <- cspade(seq_matrix_tied, 
                          parameter = list(support = 0.04), #freq sequs that occurs in at least 4% of all sequs
                          control = list(verbose = TRUE))
summary(itset_seq_tied)

#apply cSPADE algorithm to lead with support = 0.04
